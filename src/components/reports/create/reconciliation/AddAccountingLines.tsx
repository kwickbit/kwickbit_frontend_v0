...
import { MyCollectionLine } from "./MyCollectionLine";
...
export const AddAccountingLines = ({
  accountingLines,
  transaction,
  amount,
  symbolAmount,
    ...
    <div className="pb-3">
      ...
      <div className="grid grid-cols-[2fr,4.1fr] mt-3 gap-1 relative">
        {(transaction.status === 'NonPublished' && !isSwap) && (
          <button
            className="absolute bottom-14 right-0.5 w-7 h-8 flex items-center justify-center"
