    ...
    <>
      ...
      <div className="space-y-6 mb-2">
        {table.getRowModel().rows.map((row) => (
          <div
            key={row.id}
            className="relative px-4 py-8 bg-[#fefefe] rounded-xl shadow border grid grid-cols-[36px,150px,108px,60px,120px,100px,125px,125px,70px,80px,125px,100px,143px] xl:grid-cols-[36px,150fr,110fr,60px,198fr,132fr,180fr,180fr,95fr,122fr,168fr,102fr,143px]"
          >
